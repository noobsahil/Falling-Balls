...
function setup(){
    ...
    particle2 = Bodies.circle(220,10,10,particle1_options);
    World.add(world,particle2);
    particle3 = Bodies.circle(225,10,10,particle2_options);
    World.add(world,particle3);
    particle4 = Bodies.circle(230,10,10,particle3_options);
    World.add(world,particle4);
    particle5 =Bodies.circle(230,10,10,particle4_options);
